...
const Projects = () => {
  ...
  const projectImages = [project1Image, project2Image]; // Extend this list if there are more projects

  // Fetch data from the backend
  useEffect(() => {
    axios
      .get('http://localhost:8080/api/projects') // Replace with your backend endpoint
      .then((response) => {
  ...
  return (
    <section id="projects" className="container py-5">
      <div className="projects-header">
        {/* Place animation to the left of the title */}
